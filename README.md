...
<ol>The program sheevpalpatine.java checks whether the string entered is a palindrome (a word, phrase, or sequence that reads the same backward as forward)
